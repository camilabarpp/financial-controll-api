...
const transaction_type_enum_1 = require("../transaction/type/transaction.type.enum");
...
__decorate([
    (0, mongoose_1.Prop)({ enum: transaction_type_enum_1.TransactionType, required: true }),
    __metadata("design:type", String)
